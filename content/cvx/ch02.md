...
<details class="proof">
<summary>Proof: Weaker separating hyperplane theorem</summary>
...
$$\begin{align}
H = \{x | a^\top x + b \geq 0\}, \text{ where } a = (d - c), b = \frac{||c||_2^2 - ||d||_2^2}{2},
\end{align}$$
...
$$\begin{align}
|| \epsilon d' + (1 - \epsilon) d - c||_2 < ||d - c||_2,
\end{align}$$
...
<details class="proof">
<summary>Proof: Separating hyperplane theorem</summary>
...
$$\begin{align}
S_{-\epsilon} = \{x | B_\epsilon(x) \in S\}.
\end{align}$$
...
$$\begin{align}
S_{-\epsilon} \subseteq \{x | a_n^\top x - b_n \geq 0\}.
\end{align}$$
