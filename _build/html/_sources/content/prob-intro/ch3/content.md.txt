...
This can be extended to multiple random variables, by considering multiple
 convolutions in turn. However, there exist more convenient methods for
  summing independent random variables, such as [probability generating
   functions](https://en.wikipedia.org/wiki/Probability-generating_function), which are introduced in the next chapter.
